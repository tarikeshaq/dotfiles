...
# Setup Path for ngrok
export PATH="$HOME/code/ngrok-dir:$PATH"
...
# Setup PATH for make (macOS only)
if [[ "$OSTYPE" == "darwin"* ]]; then
...
export PATH="$HOME/tools/gyp:$PATH"
...
# Set up zsh syntax highlighting - NOTE: This must stay the last command
